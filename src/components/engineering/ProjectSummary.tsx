        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">
              Project Ready for Installation
            </h3>
            <div className="mt-2 text-sm text-blue-700">
              <p>
                All necessary components have been selected and verified.
                The installation team can proceed with the project following
                the provided installation guide.
              </p>
            </div>
          </div>
        </div>
